...
\begin{itemize}
    \item $\ntreeruleII{Lambda-Beta}{\typerelation{\gax}{C}{\meb}}{\gtyperelation{v}{A}}{\gberelation{\apply{(\lam{x}{A}{C})}{v} }{ C\ssub{x}{v}}{\meb}}$
    
    \item $\ntreeruleI{Lambda-Eta}{\gtyperelation{v}{\aeb}}{\gberelation{\lam{x}{A}{(\apply{v}{x}})}{v}{\aeb}}$
 

    \item $\ntreeruleII{Left Unit}{\gtyperelation{v}{A}}{\typerelation{\gax}{C}{\meb}}{\gberelation{\doin{x}{\return{v}}{C}}{C\ssub{x}{v}}{\meb}}$
    
    \item $\ntreeruleI{Right Unit}{\gtyperelation{C}{\mea}}{\gberelation{\doin{x}{C}{\return{x}} }{C}{\mea}}$
    ...
    \item $\ntreeruleII{if-true}{\gtyperelation{C_1}{\mea}}{\gtyperelation{C_2}{\mea}}{\gberelation{\ifthenelse{\e}{A}{\t}{C_1}{C_2}}{C_1}{\mea}}$
    
    \item $\ntreeruleII{if-false}{\gtyperelation{C_2}{\mea}}{\gtyperelation{C_1}{\mea}}{\gberelation{\ifthenelse{\e}{A}{\f}{C_1}{C_2}}{C_2}{\mea}}$
    
    \item $\ntreeruleII{If-Eta}{\typerelation{\G, x: \B}{C}{\mea}}{\gtyperelation{v}{\B}}{\gberelation{\ifthenelse{\e}{A}{v}{C\ssub{x}{\t}}{C\ssub{x}{\f}}}{C\ssub{x}{v}}{\mea}}$
