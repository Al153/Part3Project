...
\begin{equation}
    \treerule{Extend}{\ewrel{\P}{\w_1'}{\G'}{\G}\s\s A\subtypep B}{\ewrel{\P}{\w_1\x}{\G',x:A}{\G, x:B}}
\end{equation}
...
\newcommand\reductionExistence[0]{\section{Reduced Type Derivation}
...
\newcommand{\termSubstitutionDenotations}[1]{
    For each instance onf the effect-environment substitution relation, define a denotation morphism: $\deno{\etyperelation{\P}{\G'}{\si}{\G}}: \G' \rightarrow \in #1$
