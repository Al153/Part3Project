...
\todo{Boxify Theorems + proofs}
\todo{Theorem-ify properties}
\todo{Be careful on language used}
\todo{referencing}
\todo{Fix Cases}
\todo{Well Formed-ness, etc}
\todo{Well formedness of subtyping + weakening}
...
\begin{theorem}[Substitution Preserves Typing Relation]
...
\begin{framed}
    \begin{proof}
        ...
        \case{Lambda}
            ...
            So by the weakening property \todo{which?}, $\typerelation{\gax, y: B}{v_3}{\M{\e_3}{C}}$
            ...
            \case{If-True}
                By inversion, we have $\gtyperelation{v_1}{ A}$, $\gtyperelation{v_2}{ A}$. Hence by the typing lemma \todo{Which?}, we have $\ok{\G}$ so $\gtyperelation{\t}{\B}$ by the axiom typing rule.
