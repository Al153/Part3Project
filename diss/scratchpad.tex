...
\input{header.tex}
\begin{document}  \section{Denotations of Types}
...
\begin{itemize}
    \item $\treerule{Unit}{\ok{\G}}{\deno{\typerelation{\G}{\u}{\U}} = \term{\G} : \G \rightarrow \1}$
        
    \item $\treerule{Const}{\ok{\G}}{\deno{\typerelation{\G}{\const{A}}{A}} = \deno{\const{A}} \after \term{\G} : \G \rightarrow \deno{A}}$
         
    \item $\treerule{True}{\ok{\G}}{\deno{\typerelation{\G}{\t}{\B}} = \inl \after \term{\G} : \G \rightarrow \deno{\B} = \1+\1}$
        
    \item $\treerule{False}{\ok{\G}}{\deno{\typerelation{\G}{\f}{\B}} = \inr \after \term{\G} : \G \rightarrow \deno{\B} = \1+\1}$
    ...
    \item $\treerule{Lambda}{f = \deno{\typerelation{\gax}{C}{\meb}} : \G \times A \rightarrow \teb}{\deno{\typerelation{\G}{\lam{x}{A}{C}}{A \rightarrow \meb}} = \cur{f} : \G \rightarrow (\teb)^A}$
...
\begin{itemize}     
    ...
    \item $\treerule{If}{f = \deno{\typerelation{\G}{v}{\B}}: \G\rightarrow\1+\1 \s\s g = \deno{\typerelation{\G}{C_1}{\mea}}\s\s h = \deno{\typerelation{\G}{C_2}{\mea}}}{\deno{{\typerelation{\G}{\ifthenelse{\e}{A}{v}{C_1}{C_2}}{\mea}}} = \ifnt{\meb} \after \pr{f}{\pr{g}{h}} : \G \rightarrow \tea}$
    ...
    \item $\treerule{New-If}{
        f = \deno{\typerelation{\G}{v}{\B}}: \G\rightarrow\1+\1 
        \s\s
         g = \deno{\typerelation{\G}{C_1}{\mea}}
         \s\s 
         h = \deno{\typerelation{\G}{C_2}{\mea}}
        }{
            \deno{
                {\typerelation{\G}{\ifthenelse{\e}{A}{v}{C_1}{C_2}}{\mea}}
            } = 
                \app\after((\fld{\cur{g\after\pp}}{\cur{g\after\pp}}\after f)\times \idg)\after \diag{\G} : \G \rightarrow \tea}$
\end{itemize}
\end{document}
