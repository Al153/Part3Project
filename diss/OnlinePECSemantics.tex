...
\begin{itemize}
    ...
    \item $\ntreeruleI{\vvar}{\ok{\P,\a}}{\wellformed{\P,\a}{\a}}$
    \item $\condtreeruleI{\eweaken}{\wellformed{\P}{\a}}{\wellformed{\P,\b}{\a}}{\a\neq\b, b\notin\P}$
...
\begin{itemize}
    ...
    \item $\condtreeruleII{\vweaken}{\etyperelation{\P}{\G}{x}{A}}{\wellformed{\P}{B}}{\etyperelation{\P}{\gby}{x}{A}}{x \neq y, y\notin \dom{\G}}$
...
\section{Effect-Environment Substitutions}
    ...
    \subsection{Wellformedness}    
        ...
        \begin{itemize}
            ...
            \item $\ntreeruleIII{\eqsubtype}{\typerelation{\P'}{\si}{\P}}{\wellformed{\P'}{\e}}{\a\notin\P}{\typerelation{\P'}{\si, \a \setto\e}{(\P, \a)}}$
        \end{itemize}
...
\section{Term-Environment Substitutions}
    ...
    \[
        ...
        \quad\quad
        \condtreeruleII{\tsubextend}{\typerelation{\P'}{\si}{\P}}{\wellformed{\P'}{\e}}{\typerelation{\P'}{\si, \a \setto\e}{(\P, \a)}}{\a\notin\P}
    \]
...
\begin{framed}
    \begin{proof}
        ...
        So by inversion, $\wellformed{\P}{\e}$ so $\wellformed{\P'}{\si(\a)=\e}$
        \case{\eweaken}
...
\begin{framed}
        \begin{proof}
            ...
            so \begin{equation}
                \ntreeruleI{\eweaken}{\wellformed{\P'''}{\a}}{\wellformed{\P'}{\a}}
            \end{equation}
...
\begin{framed}
    \begin{proof}
        ...
        \begin{equation}
            \D = \ntreeruleII{\vspec}{\treeruleI{\D_1}{\etyperelation{\P}{\G}{v}{\all{\a}{A}}}}{\wellformed{\P}{\e}}{\etyperelation{\P}{\G}{\eapp{v}{\e}}{A\ssub{\a}{\e}}}
        \end{equation}
        
        By induction, we derive $\D_1'$ such that
        
        \begin{equation}
            \D' = \ntreeruleII{\vspec}{\treeruleI{\D_1'}{\etyperelation{\P}{\G'}{v\ssi}{\all{\a}{A}}}}{\wellformed{\P}{\e}}{\etyperelation{\P}{\G'}{(\eapp{v}{\e})\ssi}{A\ssub{\a}{\e}}}
        \end{equation}
...
\begin{framed}
    \begin{proof}
                ...
                To find 
                \begin{equation}
                    \reduce(\ntreeruleII{\vspec}{\treeruleI{\D_1}{\gpetyperelation{v}{\all{\a}{A}}}}{\wellformed{\P}{\e}}{\gpetyperelation{\eapp{v}{\e}}{A\ssub{\a}{\e}}})
                \end{equation}
