...
\begin{figure}
    \begin{framed}
        \begin{align*}
            \apply{(\lam{x}{A}{v_1})}{v_2} & \rightarrow v_1\ssub{x}{v_1}
        \end{align*}
    \end{framed}
    \caption{The $\beta$ reduction lambda terms of lambda terms in the effect calculus. \todo{make the arrows in these figures wiggly}}
    \label{ECBeta}
\end{figure}
...
\begin{figure}
    \begin{framed}
        \begin{align*}
            \pifthenelse{A}{\t}{v_1}{v_2} & \rightarrow v_1\\
            \pifthenelse{A}{\t}{v_2}{v_2} & \rightarrow v_2\\
        \end{align*}
    \end{framed}
...
\begin{figure}
    \begin{framed}
        \begin{align*}
            \doin{x}{\return{v_1}}{v_2} & \rightarrow v_2\ssub{x}{v_1}\\
            \doin{x}{v}{\return{x}} & \rightarrow v\\
            \doin{x}{v_1}{(\doin{y}{v_2}{v_3})} 
            & \leftrightarrow\quad  \doin{y}{(\doin{y}{v_1}{v_2})}{v_3}
        \end{align*}
    \end{framed}
