...
Next up, there needs to be a monoidal operator $\Mul: \ciu \times \ciu \rightarrow \ciu$. This means that $\Mul$ should be associative and have an identity element (which is $\deno{\1}\after\term{I}$). Furthermore $\Mul$ should be natural, which means: $\Mul(f, g)\after\theta = \Mul(f\after\theta, g\after\theta)$. Finally, $\Mul$ should preserve the operation of the multiplication of ground effects. That is, $\Mul(\deno{e_1},\deno{e_2}) = \deno{e_1\dot e_2}$ where $e_1, e_2$ are ground effects.
...
\begin{figure}[h!]
    \begin{center}
        ...
        \begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
            ...
            \node[main node,text width=20mm, fill=red](SClosure) [right of=MulNaturality]{Re-indexing Functors are S-Closed};
...
\begin{proof}
    ...
    Using induction and S-closed property, we can derive $\D'$.
    \begin{align}
