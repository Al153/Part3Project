...
\[
    \treerule{Empty}{}{\ok{\nil}}
\quad
    \condtreerule{Extend}{\ok{\P}}{\ok{\P, \a}}{\a\notin \P}
\]
...
\[
    \treerule{Nil}{}{\oke{\P}{\nil}}
    \quad
    \condtreerule{Var}{\oke{\P}{\G}\s\s \wellformed{\P}{A}}{\oke{\P}{\gax}}{x\notin\dom{\G}}
\]
...
\[
    ...
    \quad
    \condtreerule{Project}{\wrel{\w}{\P'}{\P}}{\wrel{\w\pi}{(\P', \a)}{\P}}{\a\notin\P'}
    \quad
    \condtreerule{Extend}{\wrel{\w}{\P'}{\P}}{\wrel{\w\x}{(\P', \a)}{(\P, \a)}}{\a\notin\P'}
\]
...
\[
    ...
    \quad\quad
    \condtreerule{Extend}{\typerelation{\P'}{\si}{\P}\s\s\wellformed{\P'}{\e}}{\typerelation{\P'}{\si, \a \setto\e}{(\P, \a)}}{\a\notin\P}
\]
...
\[
    ...
    \quad  
    \condtreerule{Project}{\pewrel{\w}{\G'}{\G}}{\pewrel{\w \pi}{\G, x: A}{\G}}{x \notin \dom{\G'}}
    \quad
    \condtreerule{Extend}{\pewrel{\w}{\G'}{\G}\s\s A \subtype B}{\pewrel{\w \x}{\G', x: A}{\G, x: B}}{x \notin \dom{\G'}}
\]
...
\todo{(And I'm not sure you should name $\Cz$ at all.)} 
