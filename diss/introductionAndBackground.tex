...
\todo{Question: do the requirements that you have imply that each hom-set C(I,U) forms a monoid? If they do, it might be worth mentioning this (it makes the requirements on the base category look more natural). (Also,
