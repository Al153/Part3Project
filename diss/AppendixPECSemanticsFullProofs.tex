...
\begin{theorem}[Effect Substitution Preserves Type Welfformedness]
...
\begin{theorem}[Effect Substitution Preserves Typing-Environment wellformedness]
...
\begin{theorem}[Effect Substitution and Typing Environment Denotations]
...
\begin{theorem}[Effect-Environment Weakening Preserves Typing-Environment Wellformedness]
...
\end{framed}
\begin{theorem}[Effect-Environment Weakening and Typing-Environment Denotations]
...
\begin{theorem}[Effect-Environment Weakening Preserves Terms Substitutions]
    \todo{State and prove this}
\end{theorem}
...
\begin{theorem}[Effect-Environment Weakening Preserves Typing-Environment Weakening]
    \todo{Prove wellformedness of weakening}
    \todo{Standardise vocab for term/typing environment weakening/substitution}
\end{theorem}
...
\begin{framed}
    \begin{proof}
        ...
        \case{If-Eta}
            ...
            \case{Effect-Eta}
            \todo{Use re-indexing functors rather than post composition}
            Let \begin{align*}
