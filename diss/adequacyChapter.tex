    \todo{Theorem 5.4.3: it isn't clear what "up to equational equivalence" means. If you prove that the logical relation respects the equational theory (i.e. (d, v) $\in$ R iff (d, v') $\in$ R for v $\beequiv$ v') then you can just delete "up to equational equivalence". Also, I'm not convinced that you need to define the relation on substitutions here. This is the     only place you use it (except the appendix), so you can just expand out the definition.}
