...
\begin{proof}
    ...
    \case{Boolean}
    Let $d=\deno{\zptyperelation{v}{\B}}=\deno{\zptyperelation{v}{\B}}\in \{\top, \bot\}$. By the fundamental property, $\peLogRel{d}{\B}{v}$  and $\peLogRel{d}{\B}{v}$.
    ...
    \case{Unit}
    Let $\singleton=\deno{\zptyperelation{v}{\U}}=\deno{\zptyperelation{v}{\U}}\in \{\singleton\}$. By the fundamental property, $\peLogRel{d}{\U}{v}$  and $\peLogRel{d}{\U}{v}$. Hence $\zpberelation{v\beequiv\u}{u}{\U}$.

    \case{Effect}

    Let $(n', d) = \deno{\zptyperelation{v}{\M{n}{G}}} = \deno{\zptyperelation{u}{\M{n}{G}}}$. By the fundamental property, $\peLogRel{(n', d)}{\M{n}{G}}{v}$ and $\peLogRel{(n', d)}{\M{n}{G}}{u}$. So there exists $u', v'$ such that $\peLogRel{d'}{G}{u'}$ and $\peLogRel{d'}{G}{u'}$ and:
