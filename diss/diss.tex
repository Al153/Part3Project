...
\note{
    Alan
        ...
        - Framed all theorems + neatened definitions of theorems
}
...
\begin{framed}
    \begin{definition}[S-Category for an EC Instance]\label{SCategoryDefinition}   
        ...
        \begin{enumerate}[label=\roman*.]
            ...
            \item The category has a \textit{point} morphism $\deno{\const{A}}: \1\rightarrow \deno{A}$ for each constant in EC. The object $\deno{A}$ is defined in section \todo{Ref}.
...
\begin{framed}
    \begin{theorem}[Effect Weakening on Types]\label{EffectWeakeningOnTypes}
        \todo{Enumerate}    
