...
\begin{figure}
    \todo{Fix the alignments of these}
...
\todo{Put these next to each other?}
    \begin{align*}
...
\begin{framed}
    ...
    \begin{proof}
        ...
        By inversion, we have $\D_1$ such that the derivation tree in Equation \ref{TermSubGenOne} holds. By induction on $\D_1$, we derive $\D_1'$ such that the derivation in Equation \ref{TermSubGenTwo} holds. By induction, we can decompose the denotation $\D_1'$ into $\D_1$ and a substitution, which is the weakened denotation of $\si$ (Equation \ref{TermSubGenSub}). \todo{Fix the eqs below}
...
\begin{figure}[H]
    ...
    \caption{An example case of the $\reduce$ function. Further cases can be seen \todo{Where}}
