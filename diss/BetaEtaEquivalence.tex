...
\begin{document}
    ...
    \begin{itemize}
        \item $\treerule{Lambda}{\typerelation{\G, x: A}{C}{\meb}\s\s \gtyperelation{v}{A}}{\gberelation{\apply{(\lam{x}{A}{C})}{v} }{ C\ssub{v}{x}}{\meb}}$
        
        \item $\treerule{Left Unit}{\gtyperelation{v}{A} \s\s \typerelation{\G, x: A}{C}{\meb}}{\gberelation{\doin{x}{\return{v}}{C}}{C\ssub{x}{V}}{\meb}}$
        
        \item $\treerule{Right Unit}{\gtyperelation{C}{\mea}}{\gberelation{\doin{x}{C}{\return{x}} }{C}{\mea}}$
        \item $\treerule{Associativity}{\gtyperelation{C_1}{\M{\e_1}{A}} \s\s \typerelation{\G, x: A}{C_2}{\M{\e_2}{B}}\s\s \typerelation{\G, y: B}{C_3}{\M{\e_3}{C}}}{
    ...
    \begin{itemize}
        \item $\treerule{Lambda}{\berelation{\G, x: A}{C_1}{C_2}{\meb}}{\gberelation{\lam{x}{A}{C_1}}{\lam{x}{A}{C_2}}{\lamtype{A}{\e}{B}}}$
        ...
        \item $\treerule{Bind}{\gberelation{C_1}{C_1'}{\M{\e_1}{A}} \s\s \berelation{\G, x: A}{C_2}{C_2'}{\M{\e_2}{B}}}{\gberelation{\doin{x}{C_1}{C_2}}{\doin{c}{C_1'}{C_2'}}{\M{\e_1 \cdot \e_2}{B}}}$
    ...
    \paragraph{Case Lambda}
        By inversion, we have $\typerelation{\G, x: A}{C}{\meb}$ and $\gtyperelation{v}{A}$. Hence by the typing rules, we have:
        $$\treerule{Apply}{
            \treerule{Lambda}{\typerelation{\G, x:A }{C}{\meb}}{\gtyperelation{\lam{x}{A}{C}}{\lamtype{A}{\e}{B}}}
            \s\s
            \gtyperelation{v}{A}
        }{\gtyperelation{\apply{(\lam{x}{A}{C})}{v}}{\mea}}$$

        By the substitution rule \todo{which?}, we have 
        $$\treerule{Substitution}{\typerelation{\G, x: A}{C}{\meb}\s\s\gtyperelation{v}{A}}{\gtyperelation{C\ssub{x}{v}}{\meb}}$$
