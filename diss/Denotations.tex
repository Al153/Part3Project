...
\begin{itemize}     
    ...
    \item $\treerule{If}{f = \deno{\typerelation{\G}{v}{\B}}: \G\rightarrow\1+\1 \s\s g = \deno{\typerelation{\G}{C_1}{\mea}}\s\s h = \deno{\typerelation{\G}{C_2}{\mea}}}{\deno{{\typerelation{\G}{\ifthenelse{\e}{A}{v}{C_1}{C_2}}{\mea}}} = \app\after((\fld{\cur{g\after\pp}}{\cur{g\after\pp}}\after f)\times \idg)\after \diag{\G} : \G \rightarrow \tea}$
